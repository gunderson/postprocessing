/**
 * postprocessing v1.1.2 build Nov 01 2016
  ...
  class Bokeh2Material extends THREE.ShaderMaterial {
  	...
  	constructor(camera, options) {
  		...
  		if (options.texelSize !== undefined) {
  			this.setTexelSize(options.texelSize.x, options.texelSize.y);
  		}
  		if (camera !== undefined) {
  			this.adoptCameraSettings(camera);
  		}
    ...
    */
  	...
  	dispose(renderTarget) {
  		...
  		while (this.branches.main.passes.length > 0) {
  			...
  			this.branches.main.passes.pop().dispose();
  		}
  ...
  class BloomPass extends Pass {
     ...
     */
  		...
  		if (options.strength !== undefined) {
  			this.combineMaterial.uniforms.opacity2.value = options.strength;
  		}
     ...
     */
  		...
  		if (options.strength !== undefined) {
  			this.copyMaterial.uniforms.opacity.value = options.strength;
  		}
     ...
     */
  		...
  		if (options.distinction !== undefined) {
  			this.luminosityMaterial.uniforms.distinction.value = options.distinction;
  		}
  ...
  class DotScreenPass extends Pass {
     ...
     */
  		...
  		if (options.angle !== undefined) {
  			this.material.uniforms.angle.value = options.angle;
  		}
  		if (options.scale !== undefined) {
  			this.material.uniforms.scale.value = options.scale;
  		}
  		if (options.intensity !== undefined) {
  			this.material.uniforms.intensity.value = options.intensity;
  		}
  ...
  class GodRaysPass extends Pass {
     ...
     */
  		...
  		if (options.exposure !== undefined) {
  			this.godRaysMaterial.uniforms.exposure.value = options.exposure;
  		}
  		if (options.density !== undefined) {
  			this.godRaysMaterial.uniforms.density.value = options.density;
  		}
  		if (options.decay !== undefined) {
  			this.godRaysMaterial.uniforms.decay.value = options.decay;
  		}
  		if (options.weight !== undefined) {
  			this.godRaysMaterial.uniforms.weight.value = options.weight;
  		}
  		if (options.clampMax !== undefined) {
  			this.godRaysMaterial.uniforms.clampMax.value = options.clampMax;
  		}
