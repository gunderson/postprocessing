...
(function (global, factory) {
  ...
  var BranchPass = function (_Pass) {
  	inherits(BranchPass, _Pass);

  	function BranchPass(branch) {
  		classCallCheck(this, BranchPass);

  		var _this = possibleConstructorReturn(this, Object.getPrototypeOf(BranchPass).call(this));

  		_this.branch = branch;
  		return _this;
  	}

  	createClass(BranchPass, [{
  		key: "render",
  		value: function render(renderer, readBuffer, writeBuffer, delta, maskActive) {
  ...
  var EffectComposer = function () {
    ...
    */
  	...
  	createClass(EffectComposer, [{
  		key: "addPass",
  		value: function addPass(pass, index, branchName) {
     ...
     */
  		...
  		key: "removePass",
  		value: function removePass(pass, branchName) {
